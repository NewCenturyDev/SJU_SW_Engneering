...
class StockWatchServ(metaclass=MetaSingleton):
    ...
    def _check_immi_sell_condition(self, stock, last_price):
        ...
        if int(last_price) <= int(stock.get_lastest_highest_price()) - 3 * int(stock.get_bid_unit()):
    ...
    def _check_immi_buy_condition(self, stock, last_price):
        ...
        if int(last_price) >= int(stock.get_lastest_lowest_price()) + 3 * int(stock.get_bid_unit()):
